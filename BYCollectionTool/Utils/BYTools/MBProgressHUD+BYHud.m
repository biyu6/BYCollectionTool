...
#import "MBProgressHUD+BYHud.h"

@implementation MBProgressHUD (BYHud)
...
+ (void)dissmissWindowHud{
    UIView *showView = (UIView*)[[[UIApplication sharedApplication]delegate]window];
    showView.alpha = 1;
    [self hideHUDForView:showView animated:YES];
}
//显示window上的HUD
